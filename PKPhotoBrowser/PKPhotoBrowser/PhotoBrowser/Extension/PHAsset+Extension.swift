...
private var kPKOriginImageKey: Void?
...
extension PHAsset {
    ...
    var originImage: UIImage? {
        get {
            return objc_getAssociatedObject(self, &kPKOriginImageKey) as? UIImage
        }
        set {
            objc_setAssociatedObject(self, &kPKOriginImageKey, newValue, objc_AssociationPolicy.OBJC_ASSOCIATION_RETAIN_NONATOMIC)
        }
    }
}
